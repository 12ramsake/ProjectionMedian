...
# 
# set.seed(123413)
# data2<-t(replicate(21,rnorm(3)))
# projMed(data2)
# projMed(matx)
# 
# 
# 
# data2<-rbind(c( -1.8402667  ,0.9404178 ,-1.5881718),
# c( 1.3853932,  1.2283858 , 2.0859591),
#   c(1.4207626 ,-0.5732612 ,-1.4891637)
# ,c( 0.1645484 ,-2.2108453 , 0.1008303)
# , c(-0.8395862 , 0.9474823 , 1.1924114)
# ,c(-1.4024959 ,-1.1933879, -1.3641188)
# , c(-0.8706543, -2.0621220 , 0.4399904))


# plotMiddle<-function(N=100){
#   points<-NULL
#   for(i in 1:N){
#     theta<-2*pi*i/N
#     points<-rbind(points,c(cos(theta),sin(theta),0))
#   }
#   lines3d(rbind(points,points[1,])*1.02,color="red",lwd=5)
# }
